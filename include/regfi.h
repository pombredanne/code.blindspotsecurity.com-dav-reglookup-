...
/** Enables regfi library logging for the current thread.
 *
 * XXX: finish documenting
 *
 * @ingroup regfiBase
 */
void regfi_log_start(uint16_t mask);
 ...
 * @ingroup regfiBase
 */
void regfi_log_set_mask(uint16_t mask);


/** Disables regfi library logging for the current thread.
 *
 * XXX: finish documenting
 *
 * @ingroup regfiBase
