/* 
   ...
   Copyright (C) Timothy D. Morgan 2010

     ** NOTE! The following LGPL license applies to the talloc
     ** library. This does NOT imply that all of RegLookup is released
     ** under the LGPL
...
{
	if (unlikely(!p)) return NULL;
	return __talloc_strlendup(t, p, MIN(strlen(p),n));
}
...
char *talloc_strndup_append(char *s, const char *a, size_t n)
{
	...
	return __talloc_strlendup_append(s, strlen(s), a, MIN(strlen(a),n));
}
...
char *talloc_strndup_append_buffer(char *s, const char *a, size_t n)
{
	...
	return __talloc_strlendup_append(s, slen, a, MIN(strlen(a),n));
}
